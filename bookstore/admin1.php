...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_book'])) {
        ...
        $type = $_POST['type'];
        $image = $_POST['image'];
        $sql = "INSERT INTO books (title, price, author, type, image) VALUES ('$title', '$isbn', '$price', '$author', '$type', '$image')";
        $conn->query($sql);
        ...
        $type = $_POST['type'];
        $image = $_POST['image'];
        $sql = "UPDATE books SET title='$title',  price='$price', author='$author', type='$type', image='$image' WHERE id=$id";
        $conn->query($sql);
